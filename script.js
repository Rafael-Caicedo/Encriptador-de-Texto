...
var TituloSalida = document.querySelector(".tituloSalida");
var ParrafoSalida = document.querySelector(".parrafoSalida");
...
function encriptar() {
    ...
    var salida = "";
    if(!validar(texto)){
        alert("Texto invalido, solo se admiten letras en minúscula y sin acénto.")
        return;
    }
...
function ocultar(){
    ...
    ParrafoSalida.style.display = "none";
    btnCopiar.style.display = "";
}

function mostrar(){
    salidaTexto.style.background = "#FFF no-repeat center url(imagenes/Muñeco.png)";
    TituloSalida.style.display = "";
    ParrafoSalida.style.display = "";
